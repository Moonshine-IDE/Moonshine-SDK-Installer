...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("MoonshineSDKInstallerGUICore", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("MoonshineSDKInstallerGUICore", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "Moonshine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "MoonshineSDKInstallerGUICore",
			width: 800,
			x: null,
			y: null,
		};
